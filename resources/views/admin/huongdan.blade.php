...
<div class="page">
    <div class="page-inner">
        <header class="page-title-bar">
            ...
            <h1 class="page-title">HƯỚNG DẪN WEBSITE</h1>
        </header>
        <div class="page-section">
            ...
            <div class="card">
                <div class="card-body">
                    <form method="post" action="{{ route('admin.post_instruct') }}">
                        @csrf
                        <fieldset>
                            <div class="form-group">
                                <textarea class="form-control ckeditor" id="huongdan" name="huongdan">{{ $huongdan }}</textarea>
                                <small class="form-text text-muted">Hướng dẫn nên ngắn gọn, để mọi người đọc dễ hiểu.</small>
                            </div>
