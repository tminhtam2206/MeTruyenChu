                            ...
                            <div class="container-frame-story">
                                ...
                                <div class="float-left ml-3">
                                    ...
                                    <div class="frame-button-index mt-3">
                                        <a href="{{ route('member.dashboard.my_story.add_chapter', ['name_slug'=>$val->name_slug]) }}" class="btn btn-cam mr-1 {{ statusCheck($val['status']) }}"><i class="fas fa-plus"></i> Thêm Chương</a>
                                        <a href="{{ route('member.dashboard.my_story.list_chapter', ['name_slug'=>$val->name_slug]) }}" class="btn btn-xanh mr-1"><i class="far fa-list"></i> Danh Sách Chương</a>
                                        <a href="{{ route('member.dashboard.my_story.edit', ['name_slug'=>$val->name_slug]) }}" class="btn btn-xam"><i class="far fa-edit"></i> Sửa Truyện</a>
                                    </div>
                                </div>
                                <div class="cls"></div>
                            </div>
