        ...
        <header class="page-title-bar">
            ...
            <div class="d-md-flex align-items-md-start">
                ...
                <div class="btn-toolbar">
                    <button id="btnDeleteNotifi" class="btn btn-warning">
                        <i class="fas fa-trash"></i>
                        <span class="ml-1">Xóa Thông Báo</span>
                    </button>
                </div>
            </div>
        </header>
        <div class="page-section">
            <div class="card">
                <div class="list-group list-group-messages list-group-flush list-group-bordered">
                    ...
                    <div class="list-group-item read item-notification">
...
<script>
    $(document).ready(function(){
        $('#btnDeleteNotifi').click(function(){
            $.ajax({
                url:"{{ route('member.delete.notify') }}",
                type:"get",
                data:{},
                success:function(){
